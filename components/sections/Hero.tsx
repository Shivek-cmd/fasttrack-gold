...
// Staggered word reveal — each word animates in with a delay
const wordVariants = {
...
function StaggerLine({ text, className }: { text: string; className?: string }) {
  return (
    <motion.span className={`inline-flex flex-wrap gap-x-[0.22em] ${className ?? ''}`} variants={lineVariants}>
      ...
      <div className="relative z-10 max-w-container mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 lg:pb-40">
        <div className="max-w-2xl">
          ...
          >
            ...
            {/* ONE shimmer word — right-to-left sweep */}
            <motion.span
